...
use App\Repositories\LogRepository; // Wajib ada
...
class OrderService
{
    ...
    public function __construct(OrderRepository $or, MenuRepositoryInterface $mr)
    {
        $this->orderRepo = $or;
        $this->menuRepo = $mr;
        $this->logger = new LogRepository(); // Memanggil file LogRepository.php
    }

    // ... (Method list, getOrder, createOrder sama seperti sebelumnya) ...
    ...
    // FUNGSI UPDATE STATUS (YANG ERROR TADI)
